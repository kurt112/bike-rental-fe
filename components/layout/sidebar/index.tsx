...
const Sidebar = ({
    ...
    useEffect(() => {
        ...
        // @ts-ignore
        mobileNav.current.style.transform = "translateX(-260px)";

    }, [])

    const sidebarHandler = (flag: boolean) => {
        if (flag) {
            mobileNav.current.style.transform = "translateX(0px)";
            ...
            <div className="flex flex-no-wrap h-full">
                <div style={{minHeight: 716}}
                    ...
                    <div className="px-8 h-full">
                        ...
                        <div className="flex justify-center mt-48 mb-4 w-full h-full place-content-end">
                ...
                <div
                    ...
                    <button aria-label="toggle sidebar" id="openSideBar" ref={openSideBar}
                    ...
                    <button aria-label="Close sidebar" id="closeSideBar" ref={closeSidebar}
                                ...
                                <a href="#"
                                   className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                         ...
                                         width="18" height="18" viewBox="0 0 24 24" strokeWidth="1.5"
                                         stroke="currentColor"
                                         fill="none" strokeLinecap="round" strokeLinejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z"></path>
                ...
                <div className="w-full h-full">
                    <Navbar/>
                    {children}
                    <div className="flex flex-row justify-between bg-slate-50 pt-3 pb-3 mt-5 shadow-md mr-2 ml-2 pr-2 pl-2 mb-3">
                        <p>buttons</p>
                        <p>Time</p>
                        <p>Status</p>
                    </div>
                    <div className="overflow-x-auto relative shadow-md sm:rounded-lg mr-2    ml-2">
